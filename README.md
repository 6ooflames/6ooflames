...
<div align="center">
  ...
  **Bridging infrastructure, AI, and creative 3D workflows**
  ...
  [![Resume](https://img.shields.io/badge/View-Resume-blue?style=for-the-badge&logo=github-pages)](https://6ooflames.github.io/resume/)
  [![Email](https://img.shields.io/badge/Contact-davidrobertkochelsdorf%40gmail.com-green?style=for-the-badge&logo=gmail)](mailto:davidrobertkochelsdorf@gmail.com)
  
  <div style="display:flex; gap:10px; margin-top:15px;">
    <img src="https://img.shields.io/badge/Linux-%F0%9F%9A%80-informational?style=flat&color=3776AB"/>
    <img src="https://img.shields.io/badge/Rust-Orion-orange?style=flat&color=DEA584"/>
    <img src="https://img.shields.io/badge/C%2B%2B-14-black?style=flat&color=00599C"/>
    <img src="https://img.shields.io/badge/Blender-3D-orange?style=flat&color=EA7600"/>
    <img src="https://img.shields.io/badge/LLM-RHF-purple?style=flat&color=7B3FF2"/>
  </div>
...
graph TD
    ...
    B -->|Query/Context| C[Vector DB + RAG]
    B -->|Inference| D[Ollama Local Instance]
    D --> E[Quantized Mistral/Qwen/Llama]
    E --> F{Verify with RLHF}
    F -->|Score| G[Evaluation Framework]
    G -->|Pass| H[Verified Output]
    G -->|Fail| I[Self-Correction Loop]
    I --> D
```
